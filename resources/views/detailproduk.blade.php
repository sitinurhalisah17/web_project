    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="myNavbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="/home" class="nav-link">Produk</a>
                </li>
                <li class="nav-item">
...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="{{asset('/storage/foto/'.$produk->foto)}}" class="img-fluid rounded" alt="Gambar Produk" style="width: 400px; height:400px; margin-top: 10%">
        </div>

        
        <div class="col-md-6" style="padding-top: 5%">
            <h1 style="color:#da340a">{{$produk->nama_produk}}</h1>
            <div class="d-flex align-items-start">             
                <div>
                    <p class="lead">{{$produk->deskripsi}}</p>
                    
                    <h2 class="text-danger">Rp.{{$produk->harga}}</h2>

                   
                    {{-- <ul class="list-group mb-3">
                        <li class="list-group-item">Warna:Hijau</li>
                    ...
                    <div class="d-flex mt-4 gap-2">
                        ...
                        <a href="/keranjang/{{$produk->id}}" class="btn" style="background-color: #da340a">Tambahkan ke keranjang</a>
...
<footer class="text-white text-center py-3" style="background-color: #da340a; margin-top:330px">
